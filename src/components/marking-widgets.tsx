      ...
      >
        <form onSubmit={submit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="label" htmlFor="tc-deadline">
                Hand back by
              </label>
              <input
                id="tc-deadline"
            ...
            <div>
              <label className="label" htmlFor="tc-total">
                Books (optional)
              </label>
              <input
                id="tc-total"
          ...
          <div className="flex items-center gap-3 rounded-xl bg-cream/80 px-4 py-3.5">
            ...
            {pace !== null && cls ? (
              <p className="text-[0.84rem] leading-snug text-ink">
                ...
                <strong style={{ color: cls.color }}>{cls.name}</strong> by
                then, mark at least{" "}
                <strong className="font-display text-[1.15rem] text-pen">
                  {pace}
                </strong>{" "}
                per school day.
              </p>
  ...
  return (
    <div className="flex items-center gap-1">
      <button
        ...
        disabled={pending}
        onClick={() =>
          startTransition(async () => void (await reopenPlanAction(planId)))
        }
      >
