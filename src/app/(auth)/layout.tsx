        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-10">
          ...
          <div className="max-w-md">
            <p className="font-display text-[2.6rem] font-semibold leading-[1.06] tracking-tight">
              Marking,{" "}
              <em className="italic text-pen" style={{ color: "#f3b29d" }}>
                on rails.
              </em>
            </p>
            <p className="mt-4 text-[0.95rem] leading-relaxed text-cream/75">
              Snap your timetable once. MarkFlow tells you which class to
              collect, exactly how many books to mark each day, and when to hand
              them back — so you never drown in two sets at once.
            </p>
            <ul className="mt-8 space-y-3 text-sm text-cream/85">
              {[
                {
                  icon: CalendarCheck2,
                  text: "Formative checks auto-planned every 4–8 lessons",
                },
                {
                  icon: Timer,
                  text: "Never more than two weeks between hand-backs",
                },
                {
                  icon: Layers,
                  text: "Only ever one set of books on your desk",
                },
              ].map(({ icon: Icon, text }) => (
