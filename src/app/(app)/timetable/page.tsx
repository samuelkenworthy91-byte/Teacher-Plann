  ...
  return (
    <div className="space-y-6">
      <header className="rise flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 max-w-xl text-[0.88rem] leading-relaxed text-ink-soft">
            Snap the photo once as your reference, then tap each cell to drop
            the class in. The planner counts lessons between these cells to time
            every formative.
          </p>
        </div>
      ...
      <div className="grid items-start gap-6 lg:grid-cols-[1.7fr_1fr]">
        {/* The grid */}
        <section
          className="card rise overflow-hidden p-4 sm:p-5"
        ...
        <aside className="space-y-4">
          <div className="card rise p-5" style={{ animationDelay: "120ms" }}>
            ...
            <p className="mt-1 text-[0.78rem] leading-relaxed text-ink-soft">
              Keep the original photo here as your source of truth while you
              fill the grid.
            </p>
            <div className="mt-3">
          ...
          <div className="card rise p-5" style={{ animationDelay: "180ms" }}>
            ...
            <ul className="mt-3 space-y-2">
              {perClass.map((c) => (
                ...
                >
                  ...
                  <span
                    className={`text-[0.74rem] font-medium ${c.lessons === 0 ? "text-warn" : "text-ink-soft"}`}
                  >
            ...
            {perClass.some((c) => c.lessons === 0) ? (
              <p className="mt-3 rounded-lg bg-warn-soft px-3 py-2 text-[0.74rem] font-medium leading-relaxed text-warn">
                Classes without lessons can&apos;t be planned — tap them into
                the grid.
              </p>
            ) : null}
          </div>
